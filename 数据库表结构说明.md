...
- `points` - DECIMAL(12,4) NOT NULL DEFAULT 0.0000（联创星级专用点数，支持4位小数）
- `subsidy_points` - DECIMAL(12,4) NOT NULL DEFAULT 0.0000（周补贴专用点数，支持4位小数）
- `team_reward_points` - DECIMAL(12,4) NOT NULL DEFAULT 0.0000（团队奖励专用点数，支持4位小数）
- `referral_points` - DECIMAL(12,4) NOT NULL DEFAULT 0.0000（推荐奖励专用点数，支持4位小数）
