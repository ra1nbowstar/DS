        ...
        tables = {
            'users': """
                CREATE TABLE IF NOT EXISTS users (
                    ...
                    points DECIMAL(12,4) NOT NULL DEFAULT 0.0000 COMMENT '联创星级专用点数',
                    subsidy_points DECIMAL(12,4) NOT NULL DEFAULT 0.0000 COMMENT '周补贴专用点数',
                    team_reward_points DECIMAL(12,4) NOT NULL DEFAULT 0.0000 COMMENT '团队奖励专用点数',
                    referral_points DECIMAL(12,4) NOT NULL DEFAULT 0.0000 COMMENT '推荐奖励专用点数',
